<template>
  <view class="content">
    ...
    <view class="section">
      <view class="section-left">
        <view class="section-chapter" @click="naviToChapter">
          <image
            src="../../static/section/begin_chapter.png"
            mode="aspectFill"
          />
      ...
      <view class="section-right">
        <view class="section-random" @click="naviToRandromPage">
          ...
          <image
            src="../../static/section/begin_random.png"
            mode="aspectFill"
          />
        </view>
    ...
    <tip> </tip>
    <view class="continueToDevelop"
      >功能持续开发中，打造超好用的刷题小程序</view
    >
  </view>
</template>
    ...
    getUserInfo(res) {
      ...
      uni.getUserProfile({
        ...
        success: (res) => {
          ...
          saveUserShortInfo(params).then((res) => {
            console.log(res);
            if (res.code !== 0) {
              uni.showToast({
                title: "授权失败，请重试~",
